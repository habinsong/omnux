 ...
 */
export const FIXED_SCREEN_PAGES = new Set<string>(["insights", "activity", "operations", "routing", "agents", "refactor", "skills", "notebooks", "shell", "projects", "extensions", "logic", "settings", "explore", "automate", "planning", "ask", "build"]);
