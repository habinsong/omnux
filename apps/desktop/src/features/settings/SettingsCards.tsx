...
export function StatusCard({ bridgeStatus, authStatus, lastMessage, loading, onError }: { bridgeStatus: string; authStatus: string; lastMessage: string; loading: boolean; onError: CardErrorHandler }) {
  return (
...
export function DesktopPreferencesCard({ onError }: { onError: CardErrorHandler }) {
...
export function StartOnLaunchCard({ onError }: { onError: CardErrorHandler }) {
...
export function ModelPriorityCard({ onError }: { onError: CardErrorHandler }) {
...
export function SpeechSettingsCard({ onError }: { onError: CardErrorHandler }) {
...
export function ShortcutPreferencesCard({ onError }: { onError: CardErrorHandler }) {
...
export function GlobalPermissionsCard({ onError }: { onError: CardErrorHandler }) {
...
export function DefaultProjectCard({ canRequest, onError }: { canRequest: boolean; onError: CardErrorHandler }) {
...
export function MemoryNotesCard({ store, canRequest, onError }: { store: Store; canRequest: boolean; onError: CardErrorHandler }) {
  return (
...
export function BackupPackageCard({ store, canRequest, fileInputRef, onError }: { store: Store; canRequest: boolean; fileInputRef: RefObject<HTMLInputElement | null>; onError: CardErrorHandler }) {
...
export function CloudSyncCard({ store, canRequest, onError }: { store: Store; canRequest: boolean; onError: CardErrorHandler }) {
  return (
...
export function AboutCard({ onError }: { onError: CardErrorHandler }) {
  return (
