...
public sealed partial class WebSocketGateway
{
    private static string BuildMultiChatResultJson(ConversationMultiResult result)
    {
        ...
        return "{"
               ...
               + $"\"deepseek\":\"{EscapeJson(result.DeepseekText)}\","
               + $"\"grok\":\"{EscapeJson(result.GrokText)}\","
               ...
               + $"\"deepseekModel\":\"{EscapeJson(result.DeepseekModel)}\","
               + $"\"grokModel\":\"{EscapeJson(result.GrokModel)}\","
