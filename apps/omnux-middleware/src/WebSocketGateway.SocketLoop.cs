    ...
    private async Task HandleWebSocketAsync(HttpListenerContext context, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            while (socket.State == WebSocketState.Open && !cancellationToken.IsCancellationRequested)
            {
                ...
                if (await _agentWatchdogCommandDispatcher.TryHandleAsync(
                        message,
                        socket,
                        sendLock,
                        cancellationToken
                ...
                if (await _gitOperationCommandDispatcher.TryHandleAsync(
                        message,
                        socket,
                        sendLock,
                        cancellationToken
                ...
                if (await _semanticSearchCommandDispatcher.TryHandleAsync(
                        message,
                        socket,
                        sendLock,
                        cancellationToken
