...
| 주제 | 한국어 | English |
|---|---|---|
| 5분 시작 | [열기](./QUICKSTART.md) | [Open](./en/quickstart.md) |
| 사용법 | [열기](./사용법_빠른시작.md) | [Open](./en/usage.md) |
| 아키텍처 | [열기](./아키텍처_흐름.md) | [Open](./en/architecture.md) |
| 기술 스택 | [열기](./기술스택_정리.md) | [Open](./en/tech-stack.md) |
| 환경변수와 상태 파일 | [열기](./환경변수_및_상태파일.md) | [Open](./en/environment-and-state.md) |
