...
(function () {
  const providers = [
    { id: 'gemini', name: 'Gemini 3 Pro', kind: 'api', status: 'online', role: 'general', color: '#4285F4', glyph: 'G', route: 'google/gemini-3-pro-preview', latency: '420ms' },
  ...
  const activities = [
    { id: 'a1', title: 'README branding update', type: 'build', project: 'omnux', status: 'completed', when: '2h ago', day: 'Today', summary: 'Changed 4 files', detail: 'Replaced every "omnux" reference with "omnux" across README and package metadata, and refreshed the product description.', files: ['README.md', 'package.json', 'src/app/layout.tsx', 'tauri.conf.json'] },
