...
(function () {
  ...
  function ActivityPage({ ctx, payload }) {
    ...
    const filters = [
      { id: 'all', label: 'All' }, { id: 'build', label: 'Build' }, { id: 'ask', label: 'Ask' },
      { id: 'automate', label: 'Automate' }, { id: 'compare', label: 'Compare' },
    ];    const items = D.activities.filter(a => filter === 'all' || a.type === filter);
