...
값비싼 단일 모델이나 고성능 장비 하나에 의존하지 않습니다. 동일한 Tauri 데스크톱 UI에서 Groq, Gemini, Cerebras, NVIDIA NIM, Copilot, Codex 등을 활용할 수 있으며, 그 결과를 파일, 로그, 미리보기, 복구 가능한 실행 스냅샷으로 보관합니다.
...
- Tauri 데스크톱 UI와 텔레그램 봇의 기능이 파편화되어 있습니다.
...
| 데스크톱 UI와 텔레그램의 기능 파편화 | 두 인터페이스 모두 동일한 CommandService 레이어 공유 |
...
- 미들웨어 API/WS: [http://127.0.0.1:41880/](http://127.0.0.1:41880/)
